  ...
  <div>
    <div class="conent">
      ...
      <div class="con_item">
        ...
        ></el-input>
        <div class="tips">限制100个字符只能输入英文</div>
      </div>
      <div class="con_item">
        <p class="name">
          机构名称
      ...
      <!-- <div class="con_item">
        <p class="name" style="margin-right: 97px">教学语言</p>
      ...
      <div class="con_item">
        ...
        <el-col :span="15">
          ...
          <el-select v-model="pay_unit" placeholder="请选择">
            <el-option
      ...
      <div class="con_item">
        <p class="name" style="margin-right: 0px">
          招聘人数
          <span class="xing">*</span>
        </p>
      ...
      <div class="con_item">
        <p class="name" style="margin-right: -32px">
          计划上岗时间
          <span class="xing" >*</span>
        </p>
        <el-date-picker
      ...
      <div class="con_item">
        ...
        <!-- <el-checkbox-group v-model="certificate">
          <el-checkbox
            v-for="(age, index) in certificateList"
            :label="index + 1"
            :key="index"
          >{{ age.value }}</el-checkbox>
        </el-checkbox-group>-->
  ...
  methods: {
    ...
    async getJobEdit() {
      ...
      if (res.code == 200) {
        ...
        this.pay_unit = res.data.pay_unit;
    ...
    async handleClickSubmit() {
      ...
      if (parseInt(this.endPay) < parseInt(this.startPay)) {
        let tmp = this.startPay;
        this.startPay = this.endPay;
        this.endPay = tmp;
      }
      ...
      this.teaching_time = this.teaching_time1 + "," + this.teaching_time2;
      ...
      if (this.$route.query.id) {
        if (this.companyName == "") {
          ...
          let res = await this.$post("/company/jobEdit", {
            ...
            teaching_time: this.teaching_time,
