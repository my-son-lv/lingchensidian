<template>
  <div class="content">
    <el-button class="rt_btn_2" @click="next_click">发送合同</el-button>
    <!-- <el-button class="rt_btn_2" @click="save_click">保存到草稿</el-button> -->
    <div class="t1">外籍人才推荐服务协议</div>
    <div class="t2 mt_40">甲方（委托方）：{{ sign.b_company_name }}</div>
    ...
    <div class="t3 mt_20">
      2.甲方录用乙方被推荐人，应通知其报到日期、职位名称和薪资等内容。
    </div>
    <div class="t3 mt_20">
      3.甲方为乙方推荐的候选人成功签约则视为推荐成功，甲方须按本协议第三条相应条款支付相应服务费用。对乙方提供的被推荐人，甲方当时没有录用而在其被推荐后一年内录用的，甲方同意视此为乙方推荐成功，并向乙方一次性支付本合同规定的费用。
    </div>
    <div class="t3 mt_20">
      4.如果乙方提供的简历甲方已从其他渠道获取，甲方需在乙方提交候选人后的两个工作日内书面通知乙方。如在两个工作日内未通知乙方，则候选人的来源渠道是乙方。
    </div>
    <div class="t3 mt_20">
      5.甲方应对乙方所提供的人才，不做转换推荐，否则视为该被推荐人已被甲方录用。
    </div>
    <div class="t3 mt_20">
      6.甲方从乙方获知候选人个人信息(包括但不限于姓名、性别、电话、地址、电子邮箱地址，身份证号、社保账号等，以下称"个人信息")保密，应采取合理的管理手段、技术以及物理措施保障个人信息的机密性和安全性。甲方承诺个人信息将仅为履行本合同之目的而使用，未经乙方书面同意，不得贩卖、传播、披露给任何第三方。若甲方自行获得个人信息并披露给乙方的，甲方应保证这些信息均通过合理合法的手段收集和披露。当甲方违反本条导致任何第三方对乙方提出的赔偿、诉讼等主张的，甲方同意赔偿实际损失。
    </div>

    <div class="t2 mt_40">二、乙方权力和义务</div>
    <div class="t3 mt_20">
      1.乙方坚持审慎、客观专业的态度履行本协议项下的义务。
    </div>
    <div class="t3 mt_20">
      2.乙方必须对其在委托工作中所获知的甲方企业的商业秘密、技术资料、经营信息及甲方员工信息等承担保密义务，并不得在合同期内将甲方已经确认签约聘用的候选人信息再推荐给第三方。
    </div>
    <div class="t3 mt_20">
      3.乙方有权使用甲方名称、品牌LOGO等作为乙方业绩展示对外使用，但不得用于业务展示以外的其他商业用途。
    </div>
    <div class="t3 mt_20">4.乙方有权按照本协议约定收取服务费用。</div>

    <div class="t2 mt_40">三、服务费标准及支付方式</div>
    <div class="t3 mt_20">
      1.服务费如下：人民币<el-input
        class="el_input"
        placeholder="请输入金额"
        v-model.trim="sign.money"
        maxlength="30"
      ></el-input
    ...
    <div class="t3 mt_20">
      2.付款方式：甲方应在与被推荐人签署劳动、劳务或其他录用合同后<el-input
        class="el_input"
        placeholder="请输入"
        v-model.trim="sign.day"
        maxlength="30"
      ></el-input
      ><span style="display: inline-block; margin-left: 20px">个</span>工作日内一次性支付服务费。乙方指定的收款账户信息如下：
    </div>
    ...
    <div class="t3 mt_20">甲 方：{{ sign.b_company_name }}</div>
...
<script src="./signinfo2.js"></script>
<style src="./signinfo2.css" scoped></style>
