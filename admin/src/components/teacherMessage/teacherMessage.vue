  ...
  <div class="content">
    ...
    <el-row :gutter="60" class="el_row">
      ...
      <el-col :span="10">
        ...
        ></video>
        <div v-if="videos">
          <el-button type="danger" style="line-height: 24px;padding: 0px 20px;" @click="deleteVideos">删除</el-button>
        </div>
      </el-col>
    </el-row>
    ...
    <el-row :gutter="60" class="el_row">
      ...
      <el-col :span="12" v-show="avatarUrl != ''">
        ...
        ></el-image>
        <div v-if="photos">
          <el-button type="danger" style="line-height: 24px;padding: 0px 20px;" @click="deletePhotos">删除</el-button>
        </div>
      </el-col>
    </el-row>
  ...
  methods: {
    ...
    async getTeacherEdit() {
      ...
      if (res.code == 200) {
        ...
        this.email = res.data.member[0].email;
        this.nick_name = res.data.member[0].nick_name;
    ...
    async submitMessage() {
      if (this.editId != "") {
        ...
        if (this.firstName == "") {
          ...
          let res = await this.$post("/teach/edit1", {
            id: this.editId,
            name: this.firstName,
