<template>
  <div class="side-bar-wrapper">
    <div class="bar-right">
      <div class="tab-items clearfix" @click="handleClick">
        <div
          ...
          title="会话列表"
        >
          <p style="pointer-events: none;">消息</p>
        ...
        <div
          id="friend-list"
          class="friend-list fl"
          :class="{ active: showFriendList }"
          title="好友列表"
        >
          <p style="pointer-events: none;">联系人</p>
        </div>
      </div>
...
.tab-items .messages, .tab-items .friend-list {
  position: relative;
  width: 50%;
  height: 62px;
  text-align: center;
