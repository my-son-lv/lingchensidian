  ...
  <div class="current-conversation-wrapper">
    <div class="current-conversation" @scroll="onScroll">
      <div class="header">
        ...
        <div class="close_btn" @click="handleClickClose">
          <i class="el-icon-close"></i>
        </div>
      </div>
      <div class="content" v-if="showCurrentConversation">
      ...
      <div class="footer" v-if="showMessageSendBox">
        <message-send-box v-if="showCurrentConversation" />
      </div>
    </div>
