...
<template>
  <div class="indexContatiner">
    ...
    <div class="footer_wrapper">
      ...
      <div class="btn_wrapper" @click="lookMore">查看更多</div>
    </div>
  ...
  methods: {
    ...
    async getTeacherDesc() {
      ...
      if (res.code == 200) {
        ...
        if (this.allTeacherMessages.student_age != null) {
    ...
    lookMore() {
      ...
      if (TOKEN) {
        wx.redirectTo({
          ...
          url: "../../pages/teachersDetail/main?id="+this.teacherId+'&mid='+this.teacherMid,
        });
      } else {
        wx.setStorageSync('share_teach_id',this.teacherId)
        wx.setStorageSync('share_teach_mid',this.teacherMid)
        wx.redirectTo({
          url: "/pages/login/main",
        });
      }
