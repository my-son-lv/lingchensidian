  ...
  <message-bubble :isMine="isMine" :message="message">
    <div class="custom-element-wrapper">
      ...
      <div class="text" v-else>
        <div v-for="(customMsg, id) in customList" :key="id" class="message_item" @click="seeTeacherMessage(customMsg.id)">
...
export default {
  ...
  methods: {
    ...
    seeTeacherMessage(id) {
      this.$router.push({
        path: "/main/searchteach/teachdesc",
        query: {
          id: id
        }
      });
