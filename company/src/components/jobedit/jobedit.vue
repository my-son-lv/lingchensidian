  ...
  <div class="content">
    ...
    <el-row class="row">
      ...
      <el-col :span="19" style="line-height: 40px">
        <el-checkbox-group v-model="student_age" :min="0" :max="5">
    ...
    <el-row class="row">
      ...
      <el-col :span="15">
        <el-input v-model="pay_min" type="number" min="1" placeholder="e.g10000" style="width: 20%"></el-input>-
        <el-input v-model="pay_max" placeholder="e.g20000" type="number" min="1" style="width: 20%"></el-input>
...
<style src="./jobedit.css" scoped></style>
